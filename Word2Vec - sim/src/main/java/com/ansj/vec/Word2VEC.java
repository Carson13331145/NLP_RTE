...
public class Word2VEC {
	...
	public static void main(String[] args) throws IOException {
		...
		// Arrays.toString(vec.getWordVector("涓浗")));
		// ;
		// System.out.println("姣涙辰涓�" + "\t" +
		// Arrays.toString(vec.getWordVector("姣涙辰涓�")));
		// ;
		// System.out.println("瓒崇悆" + "\t" +
		// Arrays.toString(vec.getWordVector("瓒崇悆")));
		...
		//
		// //鐢蜂汉 鍥界帇 濂充汉
		// System.out.println(vec.analogy("閭撳皬骞�", "姣涙辰涓滄�濇兂", "姣涙辰涓�"));
		// System.out.println(vec2.analogy("姣涙辰涓�", "姣涙辰涓滄�濇兂", "閭撳皬骞�"));
	}
	...
	public float distance(String queryWord1, String queryWord2) {
		float[] center = wordMap.get(queryWord1);
		float[] vector = wordMap.get(queryWord2);
		float dist = 0;
